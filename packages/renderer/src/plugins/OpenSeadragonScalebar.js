...
;(function ($) {
  ...
  $.Viewer.prototype.scalebar = function (options) {
    if (!this.scalebarInstance) {
      options = options || {}
      this.scalebarInstance = new $.Scalebar(options, this)
    } else {
   ...
   */
  $.Scalebar = function (options, viewer) {
    options = options || {}
    if (!viewer) {
  ...
  $.Scalebar.prototype = {
    ...
    destroy: function () {
      ...
      if (this.viewer.container) {
        this.viewer.container.removeChild(this.divElt)
        this.divElt = null
      }
      this.viewer.scalebarInstance = null
      this.viewer = null
    },
  }
